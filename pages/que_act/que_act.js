Page({
  ...
  tiankong:function(e){
    ...
    var that=this;
    that.setData({
      tiankong: { 'id': e.currentTarget.dataset.id, 'value': e.detail.value, 'ti_type': e.currentTarget.dataset.titype }
    })
  ...
  jianda: function (e) {
    ...
    var that = this;
    that.setData({
      jianda: { 'id': e.currentTarget.dataset.id, 'value': e.detail.value, 'ti_type': e.currentTarget.dataset.titype }
    })
